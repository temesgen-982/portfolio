...
export default function IndexPage() {
  ...
  <section class="hero">
    <div class="container hero-inner">
      ...
      <div>
        ...
        <p class="hero-bio">
          I like making things from scratch and figuring out how they work.
          <br>
          Over the past few years, I had the opportunity to work on various things, starting from small experiments up to big projects.
          <br>
          I also write articles on my
          <a href="/blog/">blog</a>
          .
        </p>
      ...
      <div class="hero-actions">
        <a class="btn btn-primary" href="/assets/Temesgen-Adane-CV.pdf" target="_blank" rel="noopener">
          ${getIcon('download')} Resume
        </a>
        <a class="btn btn-primary" href="mailto:tedenadane@gmail.com">
          ${getIcon('email')} Email
        </a>
        ${heroSocials.map(link =>
      html`<a class="btn btn-primary" href="${link.url}" title="${link.name}" target="_blank" rel="noopener">${getIcon(link.icon)}</a>`
      ).join('')}
      </div>
    </div>
  </section>
  ...
  <section class="experience section">
    <div class="container">
      ...
      <div class="timeline">${experience.map(job => html`
      ...
      <a class="view-more" href="/assets/Temesgen-Adane-CV.pdf" target="_blank" rel="noopener">
        View my full resume ${getIcon('external')}
      </a>
    </div>
  </section>
  <section class="projects section">
    <div class="container stack">
      ...
      <div class="project-cards">${projects.slice(0, 4).map(projectCard()).join('')}</div>
      <a class="view-more" href="/work/">
        All projects [${String(projects.length).padStart(2, '0')}] ${getIcon('external')}
      </a>
    </div>
  </section>
  ...
  <section class="certificates section">
    <div class="container">
      ...
      <div class="certificates-grid">${education.filter(edu => edu.certUrl).map(edu => html`
